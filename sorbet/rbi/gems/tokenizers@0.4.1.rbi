...
module Tokenizers
  class << self
    # source://tokenizers//lib/tokenizers.rb#58
    def from_file(*_arg0, **_arg1, &_arg2); end

    # source://tokenizers//lib/tokenizers.rb#54
...
class Tokenizers::Decoders::Decoder; end
...
class Tokenizers::Decoders::Metaspace < ::Tokenizers::Decoders::Decoder
  ...
  class << self
    ...
    def new(replacement: T.unsafe(nil), add_prefix_space: T.unsafe(nil)); end
  end
end
...
# source://tokenizers//lib/tokenizers.rb#52
...
module Tokenizers::FromPretrained
  ...
  # source://tokenizers//lib/tokenizers/from_pretrained.rb#90
  def cache_dir; end

  # use same storage format as Rust version
  # https://github.com/epwalsh/rust-cached-path
  #
  # source://tokenizers//lib/tokenizers/from_pretrained.rb#44
  def cached_path(cache_dir, url, options); end

  # source://tokenizers//lib/tokenizers/from_pretrained.rb#109
